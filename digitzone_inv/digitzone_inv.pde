    ...
    if (theremin == true){
      if (biggestBlobIndices.get(0) != -1){
        ...
        if (biggestBlobIndices.get(1) != -1) {
          float amplitude = map(blobs.get(biggestBlobIndices.get(0)).center().dist(blobs.get(biggestBlobIndices.get(1)).center()), 70, 120, 0.0, 1.0);
        ...
        if (biggestBlobIndices.get(2) != -1) {
          float amplitude = map(blobs.get(biggestBlobIndices.get(0)).center().dist(blobs.get(biggestBlobIndices.get(2)).center()), 70, 120, 0.0, 1.0);
          amplitude = constrain(amplitude, 0, 1);
          if (amplitude == 0) {
            oscs.get(1).stop();
          } else {
        ...
        if (biggestBlobIndices.get(3) != -1) {
          float amplitude = map(blobs.get(biggestBlobIndices.get(0)).center().dist(blobs.get(biggestBlobIndices.get(3)).center()), 70, 120, 0.0, 1.0);
          amplitude = constrain(amplitude, 0, 1);
          if (amplitude == 0) {
            oscs.get(2).stop();
          } else {
        ...
        if (biggestBlobIndices.get(4) != -1) {
          float amplitude = map(blobs.get(biggestBlobIndices.get(0)).center().dist(blobs.get(biggestBlobIndices.get(4)).center()), 70, 120, 0.0, 1.0);
          amplitude = constrain(amplitude, 0, 1);
          if (amplitude == 0) {
            oscs.get(3).stop();
          } else {
